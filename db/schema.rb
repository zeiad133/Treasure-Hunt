...
ActiveRecord::Schema.define(version: 2021_10_07_170846) do
  ...
  create_table "treasures", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
    t.string "lng"
    t.string "lat"
